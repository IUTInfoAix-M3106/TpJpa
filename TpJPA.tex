...
\lstinputlisting[language=XML,style=customxml]{persistence.xml}
...
en correspondance avec leur relation respective. Dans cette question \textbf{les associations seront ignorées} pour le moment. 
